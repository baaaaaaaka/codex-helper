...
- Add `--adapter-shell user` when the adapter or scheduler submit command depends on the user's normal shell setup, such as modules, `submit_job`, NSS, or `SUBMIT_ACCOUNT`.
