...
func teamsControlFallbackHelpContext() string {
	lines := []string{
		...
		"- `cxp beacon allocation list|status|reconcile`: inspect and reconcile managed Slurm/LSF allocation requests through configured provider adapters.",
		...
		"- Managed provider adapters are configured with `CODEX_HELPER_BEACON_SLURM_QUERY`, `CODEX_HELPER_BEACON_SLURM_SUBMIT`, `CODEX_HELPER_BEACON_SLURM_CANCEL`, `CODEX_HELPER_BEACON_SLURM_RENEW`, `CODEX_HELPER_BEACON_LSF_QUERY`, `CODEX_HELPER_BEACON_LSF_SUBMIT`, `CODEX_HELPER_BEACON_LSF_CANCEL`, and `CODEX_HELPER_BEACON_LSF_RENEW`.",
		"",
		"cxp teams digest:",
