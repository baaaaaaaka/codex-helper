...
func teamsControlFallbackHelpContext() string {
	lines := []string{
		...
		"- Managed Slurm/LSF adapters use the user's normal shell setup by default; add `--adapter-shell direct` only when an adapter needs the clean helper service environment.",
