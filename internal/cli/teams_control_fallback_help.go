...
func teamsControlFallbackHelpContext() string {
	lines := []string{
		...
		"- Add `--adapter-shell user` when the adapter depends on the user's normal shell setup, such as modules, `submit_job`, NSS, or `SUBMIT_ACCOUNT`.",
