...
func teamsControlFallbackHelpContext() string {
	lines := []string{
		...
		"- `cxp beacon release <profile|allocation|provider-job|machine>`: manually release a beacon resource without requiring the user to know its internal object type.",
